...
class User extends DBObject {
	...
	protected static $VALID_PERMISSIONS = ['system_stats', 'domains_logs', 'domains_stats', 'manage_domains', 'domains_create', 'manage_users', 'manage_permissions', 'impersonate_users', 'system_service_mgmt'];
